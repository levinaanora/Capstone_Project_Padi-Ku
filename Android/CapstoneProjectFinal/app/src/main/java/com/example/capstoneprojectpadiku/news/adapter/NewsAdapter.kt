package com.example.padi_ku.ui.news.adapter
...
import com.example.padi_ku.ui.news.DetailNewsActivity
import com.example.padi_ku.ui.news.utils.Utils.DateFormat
import com.example.padi_ku.ui.news.utils.Utils.DateTimeHourAgo
import com.makeramen.roundedimageview.RoundedImageView
import kotlinx.android.synthetic.main.list_item_news.view.*

class NewsAdapter (private val newsModel: MutableList<NewsModel>, private val context: Context):
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.frameListNews.setOnClickListener {
            ...
            intent.putExtra(DetailNewsActivity.DETAIL_NEWS, newsModel[position])
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            frameListNews = itemView.flameListNews
            tvTimeAgo = itemView.tvTime
            tvNameSource = itemView.tvSource
            tvTitleNews = itemView.tvTitle
            tvDateTime = itemView.tvDate
            imageThumbnail = itemView.imageNews
        }
    }
